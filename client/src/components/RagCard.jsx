    ...
    >
        ...
        {isMobileMenuOpen && (
          ...
          >
            <ul className="py-2" aria-labelledby="dropdownButton">
              <li>
                <a href="#" className="block px-4 py-2 text-sm text-white hover:bg-black/10">
                  View Profile
                </a>
              </li>
              <li>
      ...
      <div className="flex flex-col items-center pb-10 font-bold">
        <img
          ...
          alt="Bonnie image"
        />
        <h5 className="mb-1 text-2xl font-medium capitalize	 dark:text-white">
          {data?.name}
        </h5>
        <div className='flex flex-col p-2 gap-1 items-start'>
          <span className="text-md text-white/90">
            Charges: Rs{data?.pricePerHour}/hr
          </span>
          <span className="text-md text-white/90">
            <div className="flex items-center">
              ...
              <p className="ms-2 text-sm font-bold">{data?.ratings}</p>
          ...
          <span className="text-md text-white/90">
            Distance: {formattedDistance || 'Calculating...'}
          </span>
        </div>
